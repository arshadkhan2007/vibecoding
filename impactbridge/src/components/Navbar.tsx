...
export default async function Navbar() {
  ...
  return (
    <header className="border-b border-slate-200/80 bg-white/90 backdrop-blur-md sticky top-0 z-50 shadow-xs transition-all">
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-xl font-extrabold tracking-tight bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-600 bg-clip-text text-transparent">
                ImpactBridge
              </span>
            </Link>
            ...
            <nav className="hidden sm:flex items-center gap-1">
              <Link
                href="/problems"
                className="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm font-semibold text-slate-600 rounded-lg hover:text-blue-600 hover:bg-blue-50/60 transition-colors"
              >
          ...
          <div className="flex items-center gap-3">
            {user ? (
              ...
              <>
                <Link
                  href="/login"
                  className="text-slate-600 hover:text-blue-600 px-3.5 py-2 text-sm font-semibold rounded-lg hover:bg-slate-50 transition"
                >
                  Log in
                </Link>
                <Link
                  href="/signup"
                  className="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-sm font-semibold px-4.5 py-2 rounded-xl shadow-sm hover:shadow-md hover:shadow-blue-500/20 transition active:scale-98"
                >
                  Sign up
                </Link>
              </>
